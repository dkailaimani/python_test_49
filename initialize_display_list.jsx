...
const MoviesList = () => {
    const [movies, setMovies] = useState([
        ...
        { id: 3, title: 'Hidden Figures', genre: 'Action', description: 'Three brilliant African-American women mathematicians played pivotal roles in NASA during the early years of the U.S. space program.' }
    ]);
